...
<body>
    ...
    <section class="condition-area event-details-area section_gap">
        <div style="margin-bottom:150px">
            <ul class="term">
                <a href="viewproject.php?tid=2">
                    <li>Software-Projects</li>
                </a>
                <a href="viewproject.php?tid=1">
	...
	?>
    <section class="condition-area event-details-area section_gap">
        <h1 style="margin-left:90px;">Software-Projects</h1>
        <div class="container">

            <?php
		  $sql=mysqli_query($connect,"select * from subpro where domain='software' ORDER BY dateofposting DESC") or die(mysqli_error($connect));
    ...
    <section class="condition-area event-details-area section_gap">
        <h1 style="margin-left:90px;">Hardware-Projects</h1>
        <div class="container">

            <?php
		  $sql=mysqli_query($connect,"select * from subpro where domain='hardware' ORDER BY dateofposting DESC") or die(mysqli_error($connect));
